...
import com.easy.widgets.shortcut.google.Utils;
...
/**
 * package: com.easy.widgets.shortcut.ShortcutActivity
 * author: gyc
 * description:
 * time: create at 2022/7/4 8:54
 */
public class ShortcutActivity extends AppCompatActivity {
    ...
    private void setDynamicShortcuts() {
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N_MR1) {
            ...
            Utils.showToast(this, "设置动态快捷方式成功!");
        }
    }
    ...
    private void createPinnedShortcuts() {
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            ...
            if (shortcutManager != null && shortcutManager.isRequestPinShortcutSupported()) {
                ...
                Utils.showToast(this, "设置桌面快捷键" + (b ? "成功" : "失败") + "!");
            }
        }
    }
}