package com.easyandroid.widgets.compound;

import android.content.res.ColorStateList;

/**
 * package: com.easyandroid.widgets.compound.ColorUtils
 * author: gyc
 * description:使用tintColor生成按钮颜色和背景色
 * time: create at 2022/7/1 15:18
 */
