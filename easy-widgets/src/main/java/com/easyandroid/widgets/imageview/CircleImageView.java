...
/**
 * package: com.easyandroid.widgets.imageview.CircleImageView
 * author: gyc
 * description: 圆形ImageView
 * time: create at 2022/6/30 18:28
 */
...
public class CircleImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.CircleImgView_c_border_width, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.CircleImgView_c_border_color, DEFAULT_BORDER_COLOR);
        mBorderOverlay = a.getBoolean(R.styleable.CircleImgView_c_border_overlay, DEFAULT_BORDER_OVERLAY);
        mCircleBackgroundColor = a.getColor(R.styleable.CircleImgView_c_circle_background_color, DEFAULT_CIRCLE_BACKGROUND_COLOR);
