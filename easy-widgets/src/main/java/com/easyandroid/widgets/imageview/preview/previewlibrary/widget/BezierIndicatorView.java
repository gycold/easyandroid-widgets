package com.easyandroid.widgets.imageview.preview.previewlibrary.widget;
...
/**
 * package: com.easyandroid.widgets.imageview.preview.previewlibrary.widget.BezierBannerView
 * author: gyc
 * description: 底部标量
...
public class BezierIndicatorView extends View implements ViewPager.OnPageChangeListener {
    ...
    private static final String TAG = BezierIndicatorView.class.getName();
    ...
    private void initattrs(AttributeSet attrs) {
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.PreviewBezierIndicatorView);
        mSelectedColor = typedArray.getColor(R.styleable.PreviewBezierIndicatorView_preview_selectedColor, 0xFFFFFFFF);
        mUnSelectedColor = typedArray.getColor(R.styleable.PreviewBezierIndicatorView_preview_unSelectedColor, 0xFFAAAAAA);
        mRadius = typedArray.getDimension(R.styleable.PreviewBezierIndicatorView_preview_selectedRadius, mRadius);
        mNomarlRadius = typedArray.getDimension(R.styleable.PreviewBezierIndicatorView_preview_unSelectedRadius, mNomarlRadius);
        distance = typedArray.getDimension(R.styleable.PreviewBezierIndicatorView_preview_spacing, distance);
        typedArray.recycle();
    }
