...
/**
 * package: com.easyandroid.widgets.textview.shape.styleable.ShapeRadioButtonStyleable
 * author: gyc
 * description: RadioButton 的 Shape 属性值
 * time: create at 2022/6/29 10:44
 */
public final class ShapeRadioButtonStyleable implements IShapeDrawableStyleable, ITextColorStyleable, ICompoundButtonStyleable {
