package com.easyandroid.widgets.edittext;
...
/**
 * package: com.easyandroid.widgets.edittext.EasyEditText
 * author: gyc
 * description: 集成常用功能，如：一键清空、密码显示、禁止输入表情、号码分割等
 * time: create at 2022/7/1 18:50
 */
public class EasyEditText extends AppCompatEditText {
    ...
    private OnETextChangeListener mETextChangeListener;
    private OnEFocusChangeListener mEFocusChangeListener;
    ...
    public EasyEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setOnFocusChangeListener(new OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                if (mEFocusChangeListener != null) {
                    mEFocusChangeListener.onFocusChange(v, hasFocus);
                }
            }
        });
    }
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.EasyEditText, defStyleAttr, 0);
        ...
        disableEmoji = a.getBoolean(R.styleable.EasyEditText_e_disableEmoji, false);
        String pattern = a.getString(R.styleable.EasyEditText_e_pattern);
        mInteractionPadding = a.getDimensionPixelSize(R.styleable.EasyEditText_e_interactionPadding, DEFAULT_PADDING);
        a.recycle();
    ...
    private class MyTextWatcher implements TextWatcher {
        ...
        public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            mOldLength = s.length();
            if (mETextChangeListener != null) {
                mETextChangeListener.beforeTextChanged(s, start, count, after);
            }
        }
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            if (mETextChangeListener != null) {
                mETextChangeListener.onTextChanged(s, start, before, count);
            }
        }
        ...
        public void afterTextChanged(Editable s) {
            ...
            if (mSeparator.isEmpty()) {
                if (mETextChangeListener != null) {
                    mETextChangeListener.afterTextChanged(s);
                }
    ...
    public void setOnXTextChangeListener(OnETextChangeListener listener) {
        this.mETextChangeListener = listener;
    }

    public void setOnXFocusChangeListener(OnEFocusChangeListener listener) {
        mEFocusChangeListener = listener;
    }
     ...
     */
    public interface OnETextChangeListener {
     ...
     */
    public interface OnEFocusChangeListener {
