...
import com.easyandroid.widgets.dialog.dialog.manager.EasyDialogManager;
...
/**
 * package: com.easyandroid.widgets.dialog.dialog.EasyBaseDialog
 * author: gyc
 * description:
 * time: create at 2022/7/3 22:40
 */
public abstract class EasyBaseDialog extends DialogFragment {
    ...
    public void onDestroy() {
        super.onDestroy();
        EasyDialogManager.getInstance().over();
    }
}