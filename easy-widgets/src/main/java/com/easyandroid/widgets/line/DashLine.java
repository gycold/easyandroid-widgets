package com.easyandroid.widgets.line;
...
/**
 * package: com.easyandroid.widgets.line.DashLine
 * author: gyc
 * description:
 * time: create at 2022/7/1 16:46
 */
public class DashLine extends View {
    ...
    public DashLine(Context context, AttributeSet attrs) {
        ...
        dashWidth = typedArray.getDimension(R.styleable.DashLine_dashWidth, DEFAULT_DASH_WIDTH);
        lineHeight = typedArray.getDimension(R.styleable.DashLine_lineHeight, DEFAULT_LINE_HEIGHT);
        lineWidth = typedArray.getDimension(R.styleable.DashLine_lineWidth, DEFAULT_LINE_WIDTH);
        lineColor = typedArray.getColor(R.styleable.DashLine_lineColor, DEFAULT_LINE_COLOR);
        dashOrientation = typedArray.getInteger(R.styleable.DashLine_dashOrientation, DEFAULT_DASH_ORIENTATION);
